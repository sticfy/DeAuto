...
const queries = require('../queries/company-billing-card');
const isEmpty = require("is-empty");

let databaseColum = [{ "name": "id", "type": "int" }, { "name": "company_id", "type": "int" }, { "name": "card_type", "type": "varchar" }, { "name": "card_holder_name", "type": "text" }, { "name": "card_number", "type": "text" }, { "name": "cvv", "type": "text" }, { "name": "expired_month", "type": "varchar" }, { "name": "expired_year", "type": "varchar" }, { "name": "is_primary", "type": "int" }, { "name": "status", "type": "int" }, { "name": "created_by", "type": "int" }, { "name": "updated_by", "type": "int" }, { "name": "created_at", "type": "datetime" }, { "name": "updated_at", "type": "datetime" }];
let jsonColum = [];
