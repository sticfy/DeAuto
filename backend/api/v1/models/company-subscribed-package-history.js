...
const queries = require('../queries/company-subscribed-package-history.js');


let databaseColum =  [{"name":"id","type":"int"},{"name":"package_id","type":"int"},{"name":"company_id","type":"int"},{"name":"enroll_date","type":"date"},{"name":"expired_date","type":"date"},{"name":"price","type":"double"},{"name":"details","type":"text"},{"name":"status","type":"int"},{"name":"created_by","type":"int"},{"name":"created_at","type":"datetime"},{"name":"updated_by","type":"int"},{"name":"updated_at","type":"datetime"}];
