...
const queries = require('../queries/configuration');
const isEmpty = require("is-empty");

let databaseColum = [{ "name": "id", "type": "int" }, { "name": "page_name", "type": "varchar" }, { "name": "page_key", "type": "varchar" }, { "name": "content", "type": "text" }, { "name": "image", "type": "varchar" }, { "name": "status", "type": "int" }, { "name": "created_by", "type": "int" }, { "name": "updated_by", "type": "int" }, { "name": "created_at", "type": "datetime" }, { "name": "updated_at", "type": "datetime" }];
let jsonColum = [];
