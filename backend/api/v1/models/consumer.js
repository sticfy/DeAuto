...
const queries = require('../queries/consumer');
const queriesUser = require('../queries/user');
const userModel = require('./user');

let databaseColum = [{ "name": "id", "type": "int" }, { "name": "role_id", "type": "int" }, { "name": "first_name", "type": "varchar" }, { "name": "last_name", "type": "varchar" }, { "name": "email", "type": "varchar" }, { "name": "phone", "type": "varchar" }, { "name": "profile_image", "type": "varchar" }, { "name": "status", "type": "int" }, { "name": "created_by", "type": "int" }, { "name": "updated_by", "type": "int" }, { "name": "created_at", "type": "datetime" }, { "name": "updated_at", "type": "datetime" }];
let jsonColum = [];
