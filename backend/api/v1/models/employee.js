...
let databaseColum = [{ "name": "id", "type": "int" }, { "name": "role_id", "type": "int" }, { "name": "gender_id", "type": "int" }, { "name": "employee_id", "type": "varchar" }, { "name": "name", "type": "varchar" }, { "name": "phone", "type": "varchar" }, { "name": "email", "type": "varchar" }, { "name": "date_of_birth", "type": "date" }, { "name": "address", "type": "text" }, { "name": "profile_image", "type": "varchar" }, { "name": "status", "type": "int" }, { "name": "created_by", "type": "int" }, { "name": "updated_by", "type": "int" }, { "name": "created_at", "type": "datetime" }, { "name": "updated_at", "type": "datetime" }];
let jsonColum = [];
