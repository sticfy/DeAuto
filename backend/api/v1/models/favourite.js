...
let databaseColum = [{ "name": "id", "type": "int" }, { "name": "user_id", "type": "int" }, { "name": "item_id", "type": "int" }, { "name": "type", "type": "varchar" }, { "name": "status", "type": "int" }, { "name": "created_by", "type": "int" }, { "name": "updated_by", "type": "int" }, { "name": "created_at", "type": "datetime" }, { "name": "updated_at", "type": "datetime" }];
let jsonColum = [];
