...
const queries = require('../queries/invoice-item');


let databaseColum = [{"name":"id","type":"int"},{"name":"invoice_id","type":"int"},{"name":"price","type":"double"},{"name":"title","type":"JSON"},{"name":"qty","type":"int"},{"name":"status","type":"int"},{"name":"created_by","type":"int"},{"name":"updated_by","type":"int"},{"name":"created_at","type":"datetime"},{"name":"updated_at","type":"datetime"}];
