...
let databaseColum = [{"name":"id","type":"int"},{"name":"created_by","type":"int"},{"name":"updated_by","type":"int"},{"name":"user_id","type":"int"},{"name":"jwt_token","type":"text"},{"name":"login_device_info","type":"text"},{"name":"uuid","type":"varchar"},{"name":"status","type":"int"},{"name":"created_at","type":"datetime"},{"name":"updated_at","type":"datetime"}];
