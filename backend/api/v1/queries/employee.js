...
let table_name = "deautodb_employees";
...
let getById = () => {
    return `SELECT id,role_id,primary_supervisor_id,secondary_supervisor_id, name,code, email, phone, profile_image, address, status FROM ${table_name} where  id = ?  and status = 1 `;
};
